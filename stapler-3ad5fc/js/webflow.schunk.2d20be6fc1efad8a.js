  ...
  ["378"],
  {
        ...
        var P = (t.frame =
          ...
          M = s(function (t) {
            ...
            ((t.init = function (t) {
              ...
              N.backface &&
                W.hideBackface &&
                U(this.el, N.backface.css, "hidden");
            }),
              m("add", n),
              m("start", r),
              m("wait", function (e) {
          ...
          G = s(function (t) {
            function o() {
              var e,
                ...
                r = c.length;
              if (r)
                for (P(o), t = L(), e = r; e--; ) (n = c[e]) && n.render(t);
            }
    ...
    3949: function (e, t, n) {
      ...
      var _ = navigator.userAgent.toLowerCase(),
        ...
        I = (o.env.ios = /(ipod|iphone|ipad)/.test(_));
      ((o.env.safari = /safari/.test(_) && !b && !I),
        y &&
        ...
        (e.exports = function (e, t) {
            ...
            (m &&
              ...
              c
                ...
                : ((u = E).overlay ||
                    ...
                    V(u, !0)),
                  E.button.on("click" + g, P(E)),
                  E.menu.on("click" + g, "a", L(E)),
                  E.button.on(
                    "keydown" + g,
                    ((s = E),
                    function (e) {
            ...
            s.preview =
              function () {
                ((c = E && r.env("design")),
                  (l = r.env("editor")),
                  (n = e(document.body)),
                  (u = p.find(g)).length && (u.each(A), O(), r.resize.on(T)));
              }),
            (s.destroy = function () {
              ((w = e()), O(), u && u.length && u.each(C));
            }));
          ...
          function B(e, t) {
            if (!e.open) {
              ...
              if (
                (e.overlay &&
                  ((w = e.menu.prev()), e.overlay.show().append(e.menu)),
                n.animOver)
              ) {
                (f(e.menu)
                  .add(d)
    ...
    1970: function (e, t, n) {
      ...
      let y = Object.keys(p.QuickEffectIds),
        b = (e) => y.includes(e),
        {
          COLON_DELIMITER: I,
          BOUNDARY_SELECTOR: w,
      ...
      function ee(e, t) {
        ...
        if (
          (er({ store: t, rawData: s, allowEvents: a, testManual: c }),
      ...
      function eh({
        ...
        (o >= h.length && (0, a.default)(d, "config.loop") && (o = 0),
          0 === o && E && o++);
        let m =
            (0 === o || (1 === o && E)) && b(d.action?.actionTypeId)
              ? d.config.delay
              : void 0,
          v = (0, a.default)(h, [o, "actionItems"], []);
        if (!v.length || !G(p, s.mediaQueryKey)) return !1;
        let _ = s.hasBoundaryNodes && n ? g.getClosestElement(n, w) : null,
          y = M(v),
          I = !1;
        return (
          v.forEach((a, l) => {
            ...
            h &&
              C({
                ...
                let h = p ? z(f)?.(s, a) : null,
                  E = p ? Y(f)(s, a) : null;
                I = !0;
                let v = D({ element: s, actionItem: a }),
                  _ = N({ element: s, actionItem: a, elementApi: g }, h);
                eE({
                  store: e,
                  element: s,
                  actionItem: a,
      ...
      function eE(e) {
        let t,
          ...
          { refState: y } = h[_] || {},
          b = g.getRefType(o),
          I = m.reducedMotion && p.ReducedMotionTypes[a.actionTypeId];
        if (I && l)
    ...
    8955: function (e, t, n) {
      ...
      let {
        ...
        z = ({ store: e, event: t, element: n, eventStateKey: r }, i) => {
          let { action: a, id: u } = t,
            { actionListId: l, autoStopEventId: s } = a.config,
            f = $(e, s);
          return (
            f &&
              (0, c.stopActionGroup)({
        ...
        ep = {
          ...
          [I]: es(),
          [w]: ef(),
          [M]: { types: "ecommerce-cart-open", handler: Y(U, z) },
          [L]: { types: "ecommerce-cart-close", handler: Y(U, z) },
          [d]: {
            types: "click",
            handler: Y(
              U,
            ...
            handler: (
              ...
              switch (a) {
                ...
                default: {
                  ...
                  if (e && !0 !== U({ element: t, nativeEvent: r })) break;
              ...
              return (
                v && (_ > 0.95 || _ < 0.05) && (_ = Math.round(_)),
                (a !== u.EventBasedOn.ELEMENT || b || b !== o.elementHovered) &&
                  ((_ = f ? 1 - _ : _),
                  e.dispatch((0, l.parameterChanged)(y, _))),
                {
                  elementHovered: b,
                  clientX: p,
                  clientY: h,
            ...
            handler: (
              ...
              }
              {
                ...
                let c = o.top + Math.min(o.height * a, f),
                  d = Math.min(f + (o.top + o.height * u - c), s),
    ...
    4124: function (e, t, n) {
      ...
      let {
        ...
        eu = (e) => e.trim(),
        ec = Object.freeze({ [en]: F, [er]: P, [ei]: L }),
        el = Object.freeze({
      ...
      function ey({
        ...
        let A = (t?.action?.config?.affectedElements ?? {})[y || I] || {},
          C = !!(A.id || A.selector),
          R = t && f(e_(t.target));
        if (
          (C
            ? ((o = A.limitAffectedElements), (a = R), (u = f(A)))
            : (a = u = f({ id: y, selector: I, selectorGuids: w })),
          t && T)
        ) {
          let e = n && (u || !0 === T) ? [n] : d(R);
          if (u) {
      ...
      function eN({ element: e, actionItem: t, elementApi: n }) {
        ...
        switch (t.actionTypeId) {
          ...
          case et: {
            ...
            if (!h.IS_BROWSER_ENV) return { widthValue: c, heightValue: l };
            if (a === G) {
              let t = r(e, N);
            ...
            if (u === G) {
              let t = r(e, S);
              (i(e, S, ""), (l = o(e, "offsetHeight")), i(e, S, t));
            }
        ...
        switch (c) {
          case U:
            ...
            let m = ex
                ...
                .join(" "),
              { setStyle: A } = g;
            (eG(s, h.TRANSFORM_PREFIXED, g),
              A(s, h.TRANSFORM_PREFIXED, m),
              (function (
                { actionTypeId: e },
              ...
              })(E, d) && A(s, h.TRANSFORM_STYLE_PREFIXED, O));
            return;
          case H:
            return (function (e, t, n, r, i, o) {
              ...
              switch (r.actionTypeId) {
                case et: {
                  ...
                  (void 0 !== a &&
                    (t === G && (t = "px"), eG(e, N, o), u(e, N, a + t)),
                    void 0 !== c &&
                      (i === G && (i = "px"), eG(e, S, o), u(e, S, c + i)));
                  break;
                }
                case J:
                  var c = r.config;
          ...
          case $:
            ...
            if (P.actionTypeId === eo) {
              ...
              M(F, j, e === T && h.IS_BROWSER_ENV ? h.FLEX_PREFIXED : e);
            }
            return;
          case z: {
      ...
      function e$(e, t, n) {
        ...
        if (o === et) {
          let { config: n } = t;
          (n.widthUnit === G && r(e, N, ""), n.heightUnit === G && r(e, S, ""));
        }
        i(e, B) && eH({ effect: eV, actionTypeId: o, elementApi: n })(e);
      }
      let eH =
          ...
          switch (t.type) {
            ...
            case _: {
              let {
                ...
                l = e;
              return (
                (0, o.getIn)(l, [n, r]) !== r && (l = w(l, r, u, n, a)),
                O(l, n, c, i, a)
              );
            }
            case y: {
